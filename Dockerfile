...
RUN apt-get install -y python3-numpy python3-scipy libhdf5-dev
...
# #     pip3 install numpy scipy tables six pandas pysam pybedtools dendropy
# # 
# # ### install bedtools ###
